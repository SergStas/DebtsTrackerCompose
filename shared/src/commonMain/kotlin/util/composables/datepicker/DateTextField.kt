package util.composables.datepicker
            ...
            when (it) {
                ...
                2 -> {
                    ...
                    if (year != null) {
                        ...
                        builder.replaceRange(4, 6, yearMaxMin.substring(0, 2))
                        builder.replaceRange(6, 8, yearMaxMin.substring(2, 4))
                    }
                }
            }
        }
...
//        return GMTDate(timeInMillis).run {
//            "$dayOfMonth-${month.ordinal + 1}-$year"
//        }
//    }
//
//    /**
